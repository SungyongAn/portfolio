        ...
        <div class="flex-grow-1">
          ...
          <small class="text-muted">
            ...
            <span v-if="room.last_message_at" class="ms-2">
              <i class="fas fa-clock me-1"></i>{{ formatDate(room.last_message_at) }}
            </span>
          </small>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">ルーム名 <span class="text-danger">*</span></label>
            <input 
              type="text" 
              class="form-control" 
          ...
          <div class="mb-3">
            ...
            <textarea 
              ...
              rows="2"
              placeholder="ルームの用途など"></textarea>
          </div>

          <div class="mb-3">
            <label class="form-label">参加者を追加 <span class="text-danger">*</span></label>
            <input 
              type="text" 
              class="form-control" 
              v-model="searchQuery"
          ...
          <div v-if="selectedParticipants.length > 0" class="mb-3">
            <label class="form-label">選択された参加者（{{ selectedParticipants.length }}人）</label>
            <div class="d-flex flex-wrap gap-2">
              <span 
                ...
                <button 
                  ...
                  @click="removeParticipant(participant.id)"></button>
              </span>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button 
            ...
            @click="createRoom"
            :disabled="isLoading || !newRoom.name || selectedParticipants.length === 0">
    ...
    async searchAccounts() {
      ...
      try {
        const response = await axios.get(
          `${API_BASE_URL}/chat/accounts/search`,
