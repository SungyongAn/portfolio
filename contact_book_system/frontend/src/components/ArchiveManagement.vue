      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
              <i class="fas fa-chart-bar me-2"></i>データ保管状況
            </h5>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card bg-light">
                  <div class="card-body">
                    ...
                    <p class="fs-3 mb-1">
                      {{
                        statistics.active?.record_count?.toLocaleString() || 0
                      }}件
                    </p>
                    <p class="text-muted mb-1">
                      {{ statistics.active?.size_mb || 0 }} MB
                    </p>
                    <small class="text-muted">
                      {{ formatDate(statistics.active?.oldest_date) }} 〜
                      {{ formatDate(statistics.active?.newest_date) }}
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card bg-light">
                  <div class="card-body">
                    ...
                    <p class="fs-3 mb-1">
                      {{
                        statistics.archive?.record_count?.toLocaleString() || 0
                      }}件
                    </p>
                    <p class="text-muted mb-1">
                      {{ statistics.archive?.size_mb || 0 }} MB
                    </p>
                    <small class="text-muted">
                      {{ formatDate(statistics.archive?.oldest_date) }} 〜
                      {{ formatDate(statistics.archive?.newest_date) }}
                    </small>
                  </div>
                </div>
              </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-success text-white">
            <h5 class="mb-0">
              <i class="fas fa-search me-2"></i>アーカイブ検索
            </h5>
          </div>
          <div class="card-body">
            <div class="row g-3">
