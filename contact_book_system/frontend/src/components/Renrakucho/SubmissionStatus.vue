  ...
  <div class="d-flex justify-content-center px-2">
    <div class="d-flex" style="max-width: 900px; width: 100%">
      ...
      <div class="d-flex flex-column me-3" style="width: 150px">
        <div
          class="p-2 mb-2 rounded border bg-white text-center"
        ...
        <div
          class="p-2 mb-2 rounded border bg-white text-center"
          :class="
            displayMode === 'submitted' ? 'border-success text-success' : ''
          "
        ...
        <div
          class="p-2 mb-2 rounded border bg-white text-center"
          :class="
            displayMode === 'not_submitted' ? 'border-danger text-danger' : ''
          "
      ...
      <div class="card p-4 w-100">
        ...
        <div class="mb-4">
          <div class="d-flex align-items-center">
            <label class="form-label mb-0 me-2" style="font-size: 1rem"
              >対象日</label
            >
            <input
              type="date"
        ...
        <!-- 該当なし -->
        <div
          v-if="submissionData && displayStudents.length === 0 && !isLoading"
...
export default {
  ...
  methods: {
    ...
    getStatusBadge(student) {
      if (this.displayMode === "submitted") return "bg-success";
      if (this.displayMode === "not_submitted") return "bg-danger";
