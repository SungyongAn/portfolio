        ...
        <div class="col-12 col-md-3 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body">
              <!-- 年 -->
              <div class="mb-3">
                <label class="form-label fw-bold"><i class="fas fa-calendar-alt me-1"></i>年</label>
              ...
              <!-- 月 -->
              <div class="mb-3">
                <label class="form-label fw-bold"><i class="fas fa-calendar me-1"></i>月</label>
              ...
              <!-- 日 -->
              <div class="mb-3">
                <label class="form-label fw-bold"><i class="fas fa-calendar-day me-1"></i>日</label>
              ...
              <!-- 曜日 -->
              <div class="mb-3">
                <label class="form-label fw-bold"><i class="fas fa-calendar-week me-1"></i>曜日</label>
              ...
              <div class="d-grid gap-2 mt-2">
                <button class="btn btn-outline-secondary btn-sm" @click="selectedDay = null; selectedWeekday = null;">
              ...
              <div v-if="records.length && !isLoading">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover" style="table-layout: fixed;">
                    ...
                    <tbody>
                      <tr v-for="record in paginatedRecords" :key="record.record_date">
                        <td class="text-center">
                          <button class="btn btn-sm btn-outline-primary" @click="openModal(record)">
                        ...
                        <td>{{ formatDate(record.created_at || record.submitted_at) }}</td>
                        <td class="text-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            <div class="modal-header bg-primary text-white">
              <h5 class="modal-title"><i class="fas fa-file-alt me-2"></i>連絡帳詳細</h5>
              <button type="button" class="btn-close btn-close-white" @click="closeModal"></button>
            </div>
            <div class="modal-body">
              <div class="row g-3" v-if="selectedRecord">
                <div class="col-md-6">
                  <label class="fw-bold">対象日</label>
                  <p class="form-control-plaintext border-bottom">{{ formatDate(selectedRecord.target_date) }}</p>
                </div>
                <div class="col-md-6">
                  <label class="fw-bold">提出日</label>
                  <p class="form-control-plaintext border-bottom">{{ formatDate(selectedRecord.created_at || selectedRecord.submitted_at) }}</p>
                </div>
                <div class="col-md-6">
                  <label class="fw-bold">体調</label>
                  <p class="form-control-plaintext border-bottom">{{ selectedRecord.physical_condition }} / 5</p>
                </div>
                <div class="col-md-6">
                  <label class="fw-bold">メンタル</label>
                  <p class="form-control-plaintext border-bottom">{{ selectedRecord.mental_state }} / 5</p>
                </div>
                <div class="col-12">
                  <label class="fw-bold">体調・メンタル備考</label>
                  <div class="p-2 bg-light rounded">{{ selectedRecord.physical_mental_notes || 'なし' }}</div>
                </div>
                <div class="col-12">
                  <label class="fw-bold">振り返り</label>
                  <div class="p-2 bg-light rounded" style="white-space: pre-wrap;">{{ selectedRecord.daily_reflection }}</div>
                </div>
                <div class="col-12">
                  <label class="fw-bold">確認状況</label>
                  <p class="form-control-plaintext">
                    <span v-if="selectedRecord.teacher_checked" class="text-success fw-bold">
                      <i class="fas fa-check me-1"></i>確認済み ({{ formatDate(selectedRecord.checked_at) }})
                    </span>
    ...
    async fetchRecords() {
      ...
      try {
        const response = await axios.post(
          `${API_BASE_URL}/renrakucho-management/past-renrakucho-search`,
          payload
        );
