      ...
      <form @submit.prevent="handleCreateAccount">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" v-model="accountForm.studentNumber" :disabled="isLoading" placeholder="仮設定のため入力不要">
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" v-model="accountForm.fullName" :disabled="isLoading">
          </div>
          <div class="col-md-6">
    ...
    async handleCreateAccount(event) {
      ...
      try {
        ...
        if (this.accountForm.role === '生徒') {
          gradeValue = Number(this.accountForm.grade);
        ...
        const payload = {
          ...
          enrollment_year: Number(this.accountForm.enrollment_year),
        ...
        const response = await axios.post(`${API_BASE_URL}/account-management/register`, payload);
        ...
        this.errorMessage = error.response?.data?.detail || '登録処理中にエラーが発生しました';
      } finally {
