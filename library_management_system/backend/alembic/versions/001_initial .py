...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "code", sa.String(length=10), nullable=False, comment="学校コード (A〜E)"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column(
            "email", sa.String(length=255), nullable=False, comment="学校メールアドレス"
        ),
        sa.Column(
            "password_hash",
        ...
        sa.Column(
            "class_name", sa.String(length=20), nullable=True, comment="クラス名"
        ),
        sa.Column(
            "role",
            sa.Enum("student", "librarian", "admin", name="user_role"),
            nullable=False,
        ),
        sa.Column(
            "is_committee", sa.Boolean(), nullable=False, comment="図書委員フラグ"
        ),
        sa.Column(
            "is_active", sa.Boolean(), nullable=False, comment="退学・卒業フラグ"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=64),
            nullable=False,
            comment="SHA-256ハッシュ済みトークン",
        ),
        sa.Column(
            "expires_at",
            sa.DateTime(),
            nullable=False,
            comment="有効期限 (発行から30分)",
        ),
        sa.Column(
            "used_at", sa.DateTime(), nullable=True, comment="使用日時（1回使い捨て）"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column(
            "ndc", sa.String(length=10), nullable=True, comment="日本十進分類法コード"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "notified_at", sa.DateTime(), nullable=True, comment="準備完了通知日時"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "book_id", sa.Integer(), nullable=False, comment="対象資料（他校蔵書）"
        ),
        ...
        sa.Column(
            "deadline", sa.DateTime(), nullable=True, comment="締め切り日時（金曜15時）"
        ),
    ...
    op.create_index(
        "ix_inter_library_requests_user_id", "inter_library_requests", ["user_id"]
    )
    op.create_index(
        "ix_inter_library_requests_book_id", "inter_library_requests", ["book_id"]
    )
    op.create_index(
        "ix_inter_library_requests_status", "inter_library_requests", ["status"]
    )
    op.create_index(
        "ix_inter_library_requests_from_school",
        "inter_library_requests",
        ["from_school_id"],
    )
    op.create_index(
        "ix_inter_library_requests_to_school",
        "inter_library_requests",
        ["to_school_id"],
    )
