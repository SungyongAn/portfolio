...
async def page_addition_int(
    caluculation_integer_payload: NonDivisionCalculatorIntegerPayload,
) -> NonDivisionCalculatorResponseGeneric:
    question_list, answer = addition_int(
        caluculation_integer_payload.num_range,
    )
    return NonDivisionCalculatorResponseGeneric(
        question_list=question_list, answer=answer
    )


@router.post("/page_subtract_int")
async def page_subtract_int(
    caluculation_payload: NonDivisionCalculatorIntegerPayload,
) -> NonDivisionCalculatorResponseGeneric:
...
async def page_divide_int(
    divide_payload: DivideIntegerPayload,
) -> DivideResponseGeneric:
    question_list, answer, residue = divide_int(divide_payload.num_range)
    return DivideResponseGeneric(
        question_list=question_list, answer=answer, residue=residue
    )


@router.post("/page_addition_float")
async def page_addition_float(
    caluculation_payload: NonDivisionCalculatorFloatPayload,
) -> NonDivisionCalculatorResponseGeneric:
...
async def page_divide_float(
    divide_payload: DivideFloatPayload,
) -> NonDivisionCalculatorResponseGeneric:
