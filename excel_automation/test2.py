...
for products in P:
    ...
    data = px.chart.Reference(
        ws, min_col=2, max_col=len(Pl) + 1, min_row=4, max_row=len(D) + 4
    )
    categories = px.chart.Reference(
        ws, min_col=1, max_col=1, min_row=5, max_row=len(D) + 4
    )
